    ...
    form.addEventListener("submit",function(event){
        event.preventDefault();
                    ...
                    if((confpassword.value == password.value))//|| and if username doesnt exist or it exists already
                    {
                        //Reseting for the Last Time the Labels
                        confpasswordLabel.textContent ="";
        
                    xhr.open("POST", "scriptsphp/updateaccount.php", true);
                        ...
                        xhr.onreadystatechange = function() {
                            if (xhr.readyState === XMLHttpRequest.DONE) {
                                if (xhr.status === 200) {
                                    ...
                                    headerLabel.textContent ="Οι Αλλαγές των στοιχείων σου έγιναν αποδεκτές";
